if (Sys.getenv("USER") == "vagrant") {
  ...
  output_dir <- "/vagrant/outputs/LD_MFA_Contrast/FC/"

} else {

  geoml_src <- "/home/aiddata/Desktop/GitHub/geoML/geoML.R"
  input_src <- "/home/aiddata/Desktop/GitHub/geoML/GEF_MFA/GEF_LD_contrast.csv"
  output_dir <- "/home/aiddata/Desktop/GitHub/geoML/GEF_MFA/LD_MFA_Contrast/FC/"
