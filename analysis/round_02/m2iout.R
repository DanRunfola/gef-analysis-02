...
Vars <-  c("dist_to_all_rivers.na.mean", "dist_to_roads.na.mean",
           ...
           "ltdr_yearly_ndvi_mean.2002.mean", "iba_distance", "years_since_implementation"
)
...
VarNames <- c("Dist. to Rivers (m)", "Dist. to Roads (m)",
              ...
              "NDVI (2002, Unitless)", "Distance to IBA", "years_since_implementation"
)

out_path = "/vagrant/results/m2a/"
